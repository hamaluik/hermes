 ...
 * HL7 system interface configurations to HL7 message headers (MSH segment).
 *
 * Workflow:
...
/**
 * Interface Configuration from HL7 system
 *
 * Represents a configured HL7 interface in HL7 system, containing all
...
/**
 * Queries database for configured interfaces
 *
