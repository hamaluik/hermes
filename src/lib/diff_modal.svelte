...
<script lang="ts">
  ...
  import { compareMessages, type MessageDiff, type FieldDiff, type DiffType } from "../backend/diff";
  import { type DiffMatch } from "../backend/syntax_highlight";
  import { open as openDialog } from "@tauri-apps/plugin-dialog";
  import { readTextFile } from "@tauri-apps/plugin-fs";
  import IconEditMessage from "./icons/IconEditMessage.svelte";
