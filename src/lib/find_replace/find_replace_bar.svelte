...
<script lang="ts">
  ...
  import IconCase from "$lib/icons/IconCase.svelte";
  import IconClose from "$lib/icons/IconClose.svelte";
  import IconReplace from "$lib/icons/IconReplace.svelte";
  import IconReplaceAll from "$lib/icons/IconReplaceAll.svelte";
  import type { SearchMatch } from "$lib/editor/syntax_highlight";
