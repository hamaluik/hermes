...
-->
<script lang="ts">
  import IconModeLight from "./icons/IconModeLight.svelte";
  import IconModeDark from "./icons/IconModeDark.svelte";
  import IconModeAuto from "./icons/IconModeAuto.svelte";
