<svg
  ...
  ><style>
    .spinner_iMlZ {
      animation: spinner_BN13 1.451s step-end infinite;
    }
    .spinner_bpzn {
      animation: spinner_gk1y 1.451s step-end infinite;
    }
    .spinner_SwOY {
      animation: spinner_a9rS 1.451s step-end infinite;
    }
    @keyframes spinner_BN13 {
      0%,
      86.22%,
      100% {
        opacity: 0;
    ...
    opacity="0"
  /><path
    class="spinner_iMlZ spinner_bpzn"
    ...
    opacity="0"
  /><path
    class="spinner_iMlZ spinner_SwOY"
