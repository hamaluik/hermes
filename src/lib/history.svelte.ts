 ...
 * raw text typing, form field changes, wizards, and segment additions. A centralized
 * history manager ensures consistent behavior regardless of how the message is modified.
 *
