 ...
 * the database patients and apply patient data to HL7 message PID segments.
 *
 * Workflow:
 ...
 *
 * Represents a patient from the the database database with demographic
...
/**
 * Searches the database database for patients
 *
