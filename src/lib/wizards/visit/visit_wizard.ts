 ...
 * the database patient visits and apply visit data to HL7 message PV1 segments.
 *
 * Workflow:
...
/**
 * Visit/Encounter Record from the database
 *
 * Represents a patient visit/encounter from the the database database with
...
/**
 * Searches the database database for patient visits
 *
