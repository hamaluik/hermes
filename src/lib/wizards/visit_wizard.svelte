<!--
  ...
  Allows users to quickly populate PV1 (Patient Visit) segment data from sample visits.
  ...
  2. Queries the database for visits for that patient
...
<script lang="ts">
  ...
  import {
    ...
    wizardApplyVisit,
    type WizardVisit,
  } from "../../backend/wizards/visit_wizard";
   ...
   *
   * HL7 system stores visit types as single-character codes in the database.
