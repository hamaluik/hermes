...
3. User enters a patient MRN and clicks Search
4. Extension "looks up" the patient (simulated database)
5. Patient data is populated into the HL7 message
6. Window closes and user sees success message
...
6. Enter MRN: `12345678` or `87654321`
7. Click Search
8. Verify PID fields are populated
...
Expand the HTML to include multiple pages/steps:
